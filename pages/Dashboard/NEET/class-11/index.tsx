import styles from './class-11.module.scss';
...
export default function Index() {
    return (
        <div className={styles.class11}>
            <div className={styles.toggleLinks}>
                {/* <ButtonGroup variant="contained" color="secondary"> */}
                    <Link href="./class-11"><Button style={{ background: '#fd7c6c' }} >Class 11</Button></Link>
                    <Link href="./class-12"><Button>Class 12</Button></Link>
                {/* </ButtonGroup> */}
            </div>
